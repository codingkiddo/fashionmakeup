...
<form  method="post" id="form-validate">
    <div class="fieldset">
        ...
        <ul class="form-list">
            <li>
                ...
                <div class="input-box">
                    <input type="text" name="mail" alt="email" id="email_address" class="input-text required-entry validate-email" value="<?php echo $_SESSION['mail']?>" />
                    <?php 
                        if (isset($erreur)) {
                        	echo $erreur;
                        }
    ...
    <div class="buttons-set">
        ...
        <p class="back-link"><a href="finalindex.php"><small>&laquo; </small>Retour à l'acceuil</a></p>
