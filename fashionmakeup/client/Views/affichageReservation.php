...
<ul>
      ...
      Mes Réservations
      							...
      							<a href="ajouterReservation.php" class="menu_section" style="text-transform:uppercase;"> Passer une reservation</a>
      							<br>
      							<br>
      						<div >
                      ...
                      <?php
                       foreach ($listeReservations as $row) {
                                ...
                                echo '<td width=auto>';
                                          ...
                                          echo ' ';
                                          echo '<a href="suppressionReservation.php?id='.$row['id'].'">Annuler</a>';
                                   echo '</td>';
                                      echo '</tr>';
                       }
                      ?>
