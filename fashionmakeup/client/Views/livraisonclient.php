...
session_start();
  ...
  $listeLivraisonseffectuee=$livraisonC->afficherLivraisonseffectuee($_SESSION['id']);
...
<body>
    ...
    <!-- Page Wrap -->
        ...
        <header class="header-style-2">
            ...
            <a href="disconnect.php" class="w3-bar-item w3-button w3-border-right"class="top-links">DÉCONNEXION</a>
           </div>
            <div style="float: left">
                <a href="userprofile.php?id=<?php echo $_SESSION['id']; ?>" class="w3-bar-item w3-button w3-border-right" class="top-links">Retour</a>
            </div>
          </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h6>Aller à :</h6>
                 ...
                 <h4>Liste des livraisons en cours</h4 >
                  <div >
 ...
 <h4>Historique des livraisons </h4 >
                  <div >
                      ...
                      <tbody>
                        ...
                        <?PHP
                        foreach($listeLivraisonseffectuee as $row){
                          ?>
                          <form method="GET">
                          <tr>
                          <td><?PHP echo $row['rue']; ?></td>
