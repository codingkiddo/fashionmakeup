    ...
    <div id="wrap">
        ...
        <div class="content">
            ...
            <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
                <div class="container">
                    <h4><a href="prod.php">CONSULTER TOUS LES PRODUITS</a></h4>
                    <!-- Breadcrumb -->
                    <ol class="breadcrumb">
                                                ...
                                                <div class="items-in" >
                                                    ...
                                                    <div class="over-item">
                                                      ...
                                                      ?>
                                                            ...
                                                            <li><a href="addpanier.php?reference=<?php echo $key['reference']; ?>" class="btn-dark"><i class="fa fa-shopping-cart"></i>></a></li><br>
                                                            <!-- Rating Stars -->
                                        ...
                                        <div class="items-in">
                                            ...
                                            <div class="over-item">
                                                <ul class="animated fadeIn">
                                                    ...
                                                    <li> <a  datalighter><i class="fa fa-heart-o"></i></a></li>
                                                    <li><a href="addpanier.php?reference=<?php echo $key['reference']; ?>" class="btn-dark" ><i class="fa fa-shopping-cart"></i>></a></li>
                                                    <!-- Rating Stars -->
                                                    <li class="stars"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i></li>
                                                </ul>
                                            </div>
