        ...
        <div class="row"> 
          ...
          <div class="col-sm-6 animate fadeInRight" data-wow-delay="0.4s">
            ...
            <div class="row"> 
              ...
              <div class="col-sm-12">
                <div class="fun-share">
                  <a href="addpanier.php?reference=<?php echo $_POST['reference_p']; ?>" class="btn btn-small btn-dark">AJOUTER AU PANIER</a><a class="share-sec" href="#."><i class="fa fa-heart-o"></i></a> </div>
              </div>
              <!-- SHARE -->
            </div>
          </div>
