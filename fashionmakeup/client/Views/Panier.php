...
foreach($listeimage as $im)
                                                            {
                                                                ?>
                                    <div class="media-left media-middle"> <a href="#." class="item-img"> <img class="media-object" src="../../admin/Views/production/images/<?php echo $im['chemin'] ; ?>" alt=""> </a> </div>
<?php
                                                                        }
?>
                                    <!-- Item Name -->
...
if (!empty($Promo)) {
                ...
                if (empty($_SESSION['promo']))
                    $row->prix = $row->prix - ($row->prix*($Promo[0]->promotion/100));
                else
                    $row->prix = ($row->prix + ($row->prix*($_SESSION['promo']/100))) - ($row->prix*(($Promo[0]->promotion + $_SESSION['promo'])/100));

                $_SESSION['promo'] = $Promo[0]->promotion;
                $paniertable=new Panier (1,$_SESSION['panier'][$row->reference],$row->prix,$_SESSION['id'],$row->reference);
...
?>
                        ...
                        <div class="btn-sec">
                            ...
                            <!-- CLEAR SHOPPING CART -->
                            <a href="#." class="btn btn-dark"> <i class="fa fa-trash-o"></i> Supprimer panier </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <form action="Panier.php" method="get">
                                        <input type="text" name="code" value="" placeholder="Entrer ">
