...
<body>
            ...
            <section class="sub-banner animate fadeInUp" data-wow-delay="0.4s">
                <div class="container">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="Prod.php">CONSULTER TOUS LES PRODUITS</a></li>
                    </ol>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 animate fadeInLeft" data-wow-delay="0.2s">
                            <div class="side-bar">
                                ...
                                <br>
                                <div align="center">  
                                     <input type="range" min="5" max="100" step="5" value="96" id="min_price" name="min_price" />  
                        ...
                        <div class="col-sm-9 animate fadeInUp" data-wow-delay="0.2s">
                            ...
                            <!--======= Products =========-->
                            <div class="popurlar_product" id="product_loading">
                                <h1 style="font-weight: normal; color: #333333; font-family: 'Montserrat', sans-serif; font-size: 24px ">TOUS LES PRODUITS</h1>
                                <ul class="row">
                                    <!--NOUVEAU-->
                                            ...
                                            <li class="col-sm-4 animate fadeIn" data-wow-delay="0.5s">
                                                <div class="items-in" >
                                                    ...
                                                    <div class="details-sec">
                                                        <input type="submit" value="<?php $key['nom']; ?>" style="border: none; background-color: white; font-weight: solid;" class="font-montserrat"><hr>
 ...
 $(document).ready(function(){  
      $('#min_price').change(function(){  
           var price = $(this).val();  
           $("#price_range").text("Produit Sous prix ." + price+ " Dt");  
           $.ajax({  
