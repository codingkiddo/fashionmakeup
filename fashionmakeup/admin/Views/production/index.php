                  ...
                  <li><a><i class="fa fa-table"></i> Gestion de Commandes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="statcommande.php">Statistiques</a></li>
                                    ...
                                    <li><a><i class="fa fa-table"></i> Gestion de Clients <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="TabClients.php">Clientéles</a></li>
                      <li><a href="ajouteradmin.php">Administration</a></li>
                    </ul>
                  </li>
